...
class Dataset(object):
    ...
    def __next__(self):
        ...
        with tf.device('/cpu:0'):
            ...
            # batch_image = np.zeros((self.batch_size, self.train_input_size_h, self.train_input_size_w, 3))  #每batch的数据
    ...
    def parse_annotation(self, annotation):
        ...
        #     bboxes[:, [0, 2]] = bboxes[:, [0, 2]] * size[0]//720
        #     bboxes[:, [1, 3]] = bboxes[:, [1, 3]] * size[1]//1080
        ...
        for bbox in bboxes:
            ...
            for i in range(3):
                ...
                if np.any(iou_mask):
                    ...
                    try:
                        ...
                        print("ERROR test point 1 :" + str(e))
                        IPython.embed()
            ...
            if not exist_positive:
                ...
                try:
                    ...
                    print("Error test point 2: " + str(e))
                    IPython.embed()
