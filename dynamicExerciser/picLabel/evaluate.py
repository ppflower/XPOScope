...
class YoloTest(object):
    def __init__(self):
        ...
        self.saver.restore(self.sess, self.weight_file)  # 从保存的文件中恢复模型的参数
    ...
    def predict(self, image):
        ...
        bboxes = utils.postprocess_boxes(pred_bbox, (org_h, org_w), self.input_size,
    ...
    def predictOneImg(self, image_path):
        image_name = image_path.split('/')[-1]
        original_image = cv2.imread(image_path)
        image = cv2.resize(original_image, (720, 1280))
...
if __name__ == '__main__':
    # YoloTest().evaluate()
    YoloTest().predictOneImg("../data/screenshots/1.png")
